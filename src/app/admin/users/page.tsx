  ...
  const handleSearch = useCallback(async (customTerm?: string) => {
    ...
    try {
      ...
      if (!snapshot.empty) {
        ...
        // Fetch pings generated by this buyer from global /pings collection
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {foundUser ? (
        <div className="flex flex-col gap-8 max-w-4xl">
                ...
                <div className="space-y-6">
                  <div className="space-y-1">
                    <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest flex items-center gap-1.5">
                      <User className="h-3 w-3" /> Full Name (Display)
                    </p>
          ...
          {/* Purchase Audit History Card (Showing Pings) */}
          <Card className="border-border bg-card/40 backdrop-blur">
            <CardHeader className="border-b border-border/50">
              ...
              <CardDescription>Comprehensive list of resolved transactions (pings) associated with this account.</CardDescription>
            </CardHeader>
