                                  ...
                                  <section className="space-y-4">
                                    ...
                                    <div className="grid gap-5 bg-slate-50/50 p-6 rounded-2xl border border-slate-100 shadow-sm">
                                      ...
                                      <div className="pt-4 border-t border-slate-200/50 space-y-4">
                                        <div><p className="text-[10px] text-muted-foreground uppercase font-black mb-1">Official Email</p><p className="font-black text-sm text-primary underline decoration-2 underline-offset-4">{shop.contactEmail}</p></div>
